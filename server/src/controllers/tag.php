...
class TagController
{
    ...
    function get_by_resource($lang, $resource_id)
    {
        ...
        if (!isset($this->resource_cache[$resource_name])) {
            ...
            $resource_content = json_decode(file_get_contents(PATH_CONTENT . "/resource/$resource_name.json"), true);
    ...
    private function load_content($lang)
    {
        ...
        if (!isset($this->content_cache[$lang])) {
            ...
            $this->content_cache[$lang] = json_decode(file_get_contents(PATH_CONTENT . "/tag/tag.json"), true);

            // translate tag names
            $this->translator->translate($this->content_cache[$lang], $lang, '/tag/tag.json');
